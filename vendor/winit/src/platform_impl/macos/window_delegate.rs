...
impl WindowDelegate {
    ...
    pub fn set_blur(&self, _blur: bool) {
        // Mac App Store Guideline 2.5.1 rejects the private
        // `_CGSSetWindowBackgroundBlurRadius` symbol that upstream winit 0.30.13
        // links here. slio-git does not need window-background blur.
    }
